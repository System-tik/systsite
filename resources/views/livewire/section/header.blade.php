                        ...
                        <div class="splide__track">
                            <div class="splide__list">
                                <div class="splide__slide">
                                    <div class="grid  px-4 py-8 lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:px-52 xl:px-72">
                                        <div class="mr-auto place-self-center lg:col-span-7">
                                            ...
                                            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Amet aspernatur assumenda aut commodi consectetur cupiditate deleniti dolor doloremq</p>
                                ...
                                <div class="splide__slide">
                                    <div class="grid  px-4 py-8 lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:px-52 xl:px-72">
                                        <div class="mr-auto place-self-center lg:col-span-7">
                                            <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">APPROPOS</h1>
