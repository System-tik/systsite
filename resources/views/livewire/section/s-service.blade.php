<div>
    ...
    <section class="bg-white dark:bg-gray-900">
        ...
        @foreach ($services as $service)
            <div class="grid grid-cols-12 px-4 py-8 lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:px-52 xl:px-72">
                    <div class="flex flex-col justify-center max-w-screen-md col-span-7">
                            ...
                            <p class="mb-8 font-light text-gray-500 sm:text-xl dark:text-gray-400">{{$service->description}}</p>
                        ...
                        <div class="col-span-5">
                            {{-- <img src="{{asset(Storage::url('public/storage/'.$service->id.'.png'))}}" alt="" srcset=""> --}}
                        </div>
